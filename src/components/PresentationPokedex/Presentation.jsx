    ...
    return(
        <article>
            ...
            {presentation.map(fonctionnalite =>{
                return(
                    <li key={fonctionnalite.title}>
                        <h3>{fonctionnalite.title}</h3>
                        <p>{fonctionnalite.info}</p>
                    </li>
                )
            })}
            </ul>
